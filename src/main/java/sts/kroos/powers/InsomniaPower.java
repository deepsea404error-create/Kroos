...
public class InsomniaPower extends AbstractPower {
    public static final String POWER_ID = KroosMod.MOD_ID + ":Insomnia";
    ...
    private static final String IL = KroosMod.RES_ROOT + "powers/insomnia_large.png";
    private static final String IS = KroosMod.RES_ROOT + "powers/insomnia_small.png";
